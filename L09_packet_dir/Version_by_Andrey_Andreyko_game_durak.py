#Андрей Андрейко • Ср 12 Фев 00:12 • Ответ создан Вт 11 Фев 00:56
#https://github.com/Andrey22/Python_Lesson9_Neural_University.git
#
...
class Durak:
    ...
    def __init__(self):  # инициализатор класса
        ...
        self.card_type = []  # атрибуты класса
        ...
        if len(self.comp_cards) > 0 and len(self.player_cards) > 0 and self.turn == False and len(self.table) == 0:
            ...
            for i in range(len(self.comp_cards)):
                ...
                if (self.get_mast(Durak, self.comp_cards[i][0]) == changed_table[0][0] or self.get_mast(Durak,
                                                                                                        ...
                                                                                                        self.comp_cards[i][0]) == self.mast_kozyr) and self.comp_cards[i][1] > changed_table[0][1] and len(self.table) == 1:
 ...
 \
            ...
            for i in range(len(self.player_cards)):
                ...
                if (self.get_mast(Durak, self.player_cards[i][0]) == changed_table[0][0] or self.get_mast(Durak,
                                                                                                          ...
                                                                                                          self.player_cards[i][0]) == self.mast_kozyr) and self.player_cards[i][1] > changed_table[0][1] and len(self.table) == 1:
