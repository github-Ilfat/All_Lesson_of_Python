...
6) Замерить время генерации отчета (время выполнения пункта 3).
   В каждый файл пунктов 4 и 5 добавил параметр: время, затраченное на генерацию отчета.
'''
print('------------------------------------------------------------------------------------------------------------')
...
# США,367629,+5303,+2%,10941,+227,+3%,19810,+497,+3%,2.98%
# Италия,132547,,,16523,,,22837,,,12.47%

# преобразование csv данных в dict формат с текстовыми значениями
#dist1 ={'Страна':'США','Заражений':'367629','(за сутки)':'+5303','(%)':'+2%','Смертей':'10941','(за сутки)':'+227','(%)':'+3%','Выздоровлений':'19810','(за сутки)':'+497','(%)':'+3%','% Смертей':'2.98%'}
#dist2 ={'Страна':'Италия','Заражений':'132547','(за сутки)':'',(%):'','Смертей':'16523','(за сутки)':'',(%):'','Выздоровлений':'22837','(за сутки)':'',(%):'','% Смертей':'12.47%'}
